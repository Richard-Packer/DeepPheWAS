...
Usage:
    03a_phecode_generation.R (--health_data=<FILE> --sex_info=<FILE>) (--phecode_save_file=<FILE> | --no_phecodes) (--no_range_ID | --range_ID_save_file=<FILE>) [--control_exclusions=<FILE> --N_cores=<number> --ICD10=<text_comma> --ICD9=<text_comma>]
