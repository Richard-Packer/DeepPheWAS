...
Usage:
    04_formula_phenotypes.R (--min_data=<FILE> --phenotype_save_file=<FILE>) [--data_field_phenotypes=<FILE> --sex_info=<FILE> --PheWAS_manifest_overide=<FILE> --phecode_phenotypes=<FILE> --composite_phenotypes=<FILE>]
...
Options:
    ...
    --phecode_phenotypes=<FILE>               Full path of the phecodes.RDS file produced by 03a_phecode_generation.R.
    --composite_phenotypes=<FILE>             Full path of the composite_phenotypes.RDS file produced by 05_composite_phenotypes.R.
